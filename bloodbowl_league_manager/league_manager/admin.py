...
from .models import League, Team, Player, PlayerType, Faction, Match, Touchdown, PassCompletion, Casualty, Interception, MostValuablePlayer, InjuryType, Injury, LevelUp, Skill, StatIncrease
...
admin.site.register(StatIncrease)
